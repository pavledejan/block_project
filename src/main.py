    ...
    if tutorial:
        ...
        if player.if_not_dead():
            ...
            if battle_state == "enemy_turn":
                # Only execute once
                player.which_animation_pl = "idle"
                if nooblet1.if_not_dead():
                    while nooblet1.go_to_player():
                        nooblet1.which_animation_en = "walk1"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        nooblet1.drawing_animation()
                        pg.display.update()
                        pg.time.wait(50)
                        nooblet1.which_animation_en = "walk2"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        nooblet1.drawing_animation()
                        pg.display.update()
                        pg.time.wait(50)
                    nooblet1.which_animation_en = "sword1"
                    screen.blit(bckgr_scale, bckgr_rect)
                    player.drawing_animation()
                    nooblet1.drawing_animation()
                    pg.display.update()
                    pg.time.wait(250)
                    nooblet1.which_animation_en = "sword2"
                    screen.blit(bckgr_scale, bckgr_rect)
                    player.drawing_animation()
                    nooblet1.drawing_animation()
                    pg.display.update()
                    ...
                    while nooblet1.go_back():
                        ...
                        pg.display.update()
                        pg.time.wait(50)
                    nooblet1.which_animation_en = "idle"
                    player.nooblet_dmg()
            ...
            if battle_state == "player_super_attack":
                ...
                if nooblet2.if_not_dead():
                    while nooblet2.go_to_player():
                        nooblet2.which_animation_en = "walk1"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        nooblet2.drawing_animation()
                        pg.display.update()
                        pg.time.wait(50)
                        nooblet2.which_animation_en = "walk2"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        nooblet2.drawing_animation()
                        pg.display.update()
                        pg.time.wait(50)
                    nooblet2.which_animation_en = "sword1"
                    screen.blit(bckgr_scale, bckgr_rect)
                    player.drawing_animation()
                    nooblet2.drawing_animation()
                    pg.display.update()
                    pg.time.wait(250)
                    nooblet2.which_animation_en = "sword2"
                    screen.blit(bckgr_scale, bckgr_rect)
                    player.drawing_animation()
                    nooblet2.drawing_animation()
                    pg.display.update()
                    ...
                    while nooblet2.go_back():
                        ...
                        pg.display.update()
                        pg.time.wait(50)
                    nooblet2.which_animation_en = "idle"
                    player.nooblet_dmg()
                if noobador1.if_not_dead():
                    ...
                    if nbdr_att_result == "slam":
                        while noobador1.go_to_player():
                            noobador1.which_animation_en = "walk1"
                            screen.blit(bckgr_scale, bckgr_rect)
                            player.drawing_animation()
                            noobador1.drawing_animation()
                            pg.display.update()
                            pg.time.wait(50)
                            noobador1.which_animation_en = "walk2"
                            screen.blit(bckgr_scale, bckgr_rect)
                            player.drawing_animation()
                            noobador1.drawing_animation()
                            pg.display.update()
                            pg.time.wait(50)
                        noobador1.which_animation_en = "slam1"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        noobador1.drawing_animation()
                        pg.display.update()
                        pg.time.wait(250)
                        noobador1.which_animation_en = "slam2"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        noobador1.drawing_animation()
                        pg.display.update()
                        ...
                        while noobador1.go_back():
                            ...
                            pg.display.update()
                            pg.time.wait(50)
                        noobador1.which_animation_en = "idle"
                        ...
                        while noobador1.go_to_player():
                            ...
                            pg.display.update()
                            pg.time.wait(50)
                        noobador1.which_animation_en = "punch1"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        noobador1.drawing_animation()
                        pg.display.update()
                        pg.time.wait(250)
                        noobador1.which_animation_en = "punch2"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        noobador1.drawing_animation()
                        pg.display.update()
                        ...
                        noobador1.which_animation_en = "cure1"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        noobador1.drawing_animation()
                        pg.display.update()
                        pg.time.wait(250)
                        noobador1.which_animation_en = "cure2"
                        screen.blit(bckgr_scale, bckgr_rect)
                        player.drawing_animation()
                        noobador1.drawing_animation()
                        pg.display.update()
